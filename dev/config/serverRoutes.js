...
import {webMapTypeAction} from '../config/redux/webMapAction'
import {WebMapType} from '../config/redux/webMapReducer'
        ...
        renderActions: [
            (url, params, store) => {
                return new Promise((res, rej) => {
                    ...
                    store.dispatch(webMapTypeAction(WebMapType.ArticleMap));
                    res();
                })
            }
        ],
